...
| CLM-CMP-001 | All three implementations can produce a schema-valid recommendation for the same target and write it to the same Drupal review queue. | Cross-framework | TODO | Gate 0.5 not run | hypothesis | Do not use yet. |
