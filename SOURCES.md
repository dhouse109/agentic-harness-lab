...
| SRC-LG-001 | LangGraph checkpointing documentation | yes | https://docs.langchain.com/oss/python/langgraph/persistence | 2026-08-10 | current official docs; local pins LangGraph 1.2.10 / SQLite checkpointer 3.1.1 | Persistence, checkpoints, `thread_id`, and resume behavior | Official docs explain framework behavior; pair with retained Step 2A.04/2A.08 local evidence | verified source |
| SRC-LG-002 | LangGraph interrupt documentation | yes | https://docs.langchain.com/oss/python/langgraph/interrupts | 2026-08-10 | current official docs; local pin LangGraph 1.2.10 | `interrupt()` persistence and `Command(resume=...)` continuation | Official docs explain framework behavior; pair with retained Step 2A.06/2A.08 local evidence | verified source |
| SRC-LG-003 | LangChain tools documentation | yes | https://docs.langchain.com/oss/python/langchain/tools | 2026-08-10 | current official docs; local pin LangChain 1.3.14 | `@tool` construction, schemas, and structured tool returns | Official docs explain the tool abstraction; pair with retained Step 2A.03 adapter/compliance evidence | verified source |
